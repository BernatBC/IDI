...
void main()
{
  ...
  vec3 fcolor = Ambient() + Difus(NormSCO2, L1, colorFocusAmb) + Difus(NormSCO2, L2, colorFocus) + Especular(NormSCO2, L1, vertSCO ,colorFocusAmb) + Especular(NormSCO2, L2, vertSCO ,colorFocus);
