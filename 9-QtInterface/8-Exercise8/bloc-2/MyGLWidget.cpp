...
void MyGLWidget::modelTransform1()
{
  ...
  if (patricio_activat) {
    transform = glm::translate(transform, glm::vec3(1.5, 0, 2));
    ...
    transform = glm::scale(transform, glm::vec3(1/patricioScale));
    transform = glm::translate(transform, glm::vec3(-patricioCenter.x, -patricioCenter.y, -patricioCenter.z));
  }
  else {
    ...
    transform = glm::scale(transform, glm::vec3(1/legomanScale));
...
void MyGLWidget::setR(int num) {
  makeCurrent();
  floorColor[0] = (float)num/255;
  update();
}

void MyGLWidget::setG(int num) {
  makeCurrent();
  floorColor[1] = (float)num/255;
  update();
}

void MyGLWidget::setB(int num) {
  makeCurrent();
  floorColor[2] = (float)num/255;
  update();
}

void MyGLWidget::updateFloorColor() {
  glm::vec3 color[6] = {
  floorColor,
  floorColor,
  floorColor,
...
void MyGLWidget::setbR(int num) {
  makeCurrent();
  backgroundColor[0] = num;
  updateBackgroundColor();
  update();
}

void MyGLWidget::setbG(int num) {
  makeCurrent();
  backgroundColor[1] = num;
  updateBackgroundColor();
  update();
}

void MyGLWidget::setbB(int num) {
  makeCurrent();
  backgroundColor[2] = num;
  updateBackgroundColor();
  update();
}

void MyGLWidget::updateBackgroundColor() {
